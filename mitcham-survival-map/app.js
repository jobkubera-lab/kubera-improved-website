...
const verifiedPlaces = [
  { id:'lavender-park', name:'Lavender Park', lat:51.3999, lng:-0.1598, categories:['football','playground'], address:'Steers Mead, Mitcham, CR4 3SE', description:'Accessible toddler and junior play areas beside a modern 3G five-a-side football area.', source:'verified', sourceUrl:'https://www.merton.gov.uk/leisure-recreation-and-culture/parks-and-open-spaces/play-areas/mitcham' },
  { id:'edenvale', name:'Edenvale Open Space', lat:51.4071, lng:-0.1530, categories:['basketball','football','playground'], address:'Woodland Way, Mitcham, CR4 2DZ', description:'Accessible play equipment with a single football goal and a basketball post in the adjacent grass area.', source:'verified', sourceUrl:'https://www.merton.gov.uk/leisure-recreation-and-culture/parks-and-open-spaces/play-areas/mitcham' },
  { id:'rowan-road', name:'Rowan Road Recreation Ground', lat:51.4194, lng:-0.1448, categories:['basketball','football','playground'], address:'Rowan Road, Mitcham, SW16 5JF', description:'Large play area with a paddling pool, kickabout space and basketball nets.', source:'verified', sourceUrl:'https://www.merton.gov.uk/leisure-recreation-and-culture/parks-and-open-spaces/play-areas/mitcham' },
  { id:'donnelly-green', name:'Donnelly Green', lat:51.4167, lng:-0.1515, categories:['playground'], address:'South Lodge Avenue, Mitcham, CR4 1LT', description:'Separate junior and toddler areas with swings, roundabout and multi-activity units.', source:'verified', sourceUrl:'https://www.merton.gov.uk/leisure-recreation-and-culture/parks-and-open-spaces/play-areas/mitcham' },
  { id:'lewis-road', name:'Lewis Road Recreation Ground', lat:51.4110, lng:-0.1773, categories:['football','playground'], address:'Lewis Road, Mitcham, CR4', description:'Toddler and junior play areas, paddling pool and a kickabout area.', source:'verified', sourceUrl:'https://www.merton.gov.uk/leisure-recreation-and-culture/parks-and-open-spaces/play-areas/mitcham' },
  { id:'london-road-fields', name:'London Road Playing Fields', lat:51.3960, lng:-0.1689, categories:['football','playground'], address:'London Road, Mitcham, CR4', description:'Play areas for toddlers and juniors within a large open space suitable for informal sport.', source:'verified', sourceUrl:'https://www.merton.gov.uk/leisure-recreation-and-culture/parks-and-open-spaces/play-areas/mitcham' },
  { id:'sherwood-rec', name:'Sherwood Recreation Ground', lat:51.4152, lng:-0.1467, categories:['playground'], address:'Abbots Road, Mitcham, CR4 1JS', description:'Grass recreation area with toddler and junior play equipment and tennis courts outside school hours.', source:'verified', sourceUrl:'https://www.merton.gov.uk/leisure-recreation-and-culture/parks-and-open-spaces/play-areas/mitcham' },
  { id:'tamworth-farm', name:'Tamworth Farm Recreation Ground', lat:51.3982, lng:-0.1639, categories:['playground'], address:'London Road, Mitcham, CR4 2JA', description:'Play equipment for toddlers and juniors, paddling pool and tennis courts.', source:'verified', sourceUrl:'https://www.merton.gov.uk/leisure-recreation-and-culture/parks-and-open-spaces/play-areas/mitcham' },
  { id:'mitcham-cricket-green', name:'Mitcham Cricket Green', lat:51.4006, lng:-0.1676, categories:['cricket'], address:'Cricket Green, Mitcham, CR4', description:'Historic cricket area at the centre of Mitcham. Check club fixtures and access before playing.', source:'verified', sourceUrl:'https://www.merton.gov.uk/leisure-recreation-and-culture/parks-and-open-spaces' },
  { id:'mitcham-post', name:'Mitcham Post Office', lat:51.4091, lng:-0.1685, categories:['post'], address:'5 Langdale Parade, Mitcham, CR4 2PF', description:'Royal Mail and Parcelforce services. Mon–Fri 08:30–17:30; Sat 08:30–13:00.', source:'verified', sourceUrl:'https://www.postoffice.co.uk/branch-finder/174013x/mitcham' },
  { id:'church-road-post', name:'Church Road Post Office', lat:51.4033, lng:-0.1777, categories:['post'], address:'57–59 Church Road, Mitcham, CR4 3BF', description:'Post, banking, document certification and selected travel services.', source:'verified', sourceUrl:'https://www.postoffice.co.uk/branch-finder/0690139/church-road' },
  { id:'london-road-post', name:'London Road 494 Post Office', lat:51.3927, lng:-0.1675, categories:['post'], address:'494 London Road, Mitcham, CR4 4BA', description:'Long weekday hours plus Sunday opening; mail, banking, parcel and travel services.', source:'verified', sourceUrl:'https://www.postoffice.co.uk/branch-finder/0920134/london-road-494' },
  { id:'garth-road', name:'Garth Road Household Reuse and Recycling Centre', lat:51.3905, lng:-0.2038, categories:['recycling','donations'], address:'63–69 Amenity Way, Morden, SM4 4AX', description:'Reuse and recycling centre for Merton residents. Cars need a booking; pedestrians and cyclists do not.', source:'verified', sourceUrl:'https://www.merton.gov.uk/rubbish-and-recycling/garth-road' },
  { id:'majestic-way-textiles', name:'Majestic Way Textile Recycling Bank', lat:51.4098, lng:-0.1684, categories:['recycling','donations'], address:'Majestic Way, Mitcham', description:'Council-listed textile recycling point for clean clothing and paired shoes.', source:'verified', sourceUrl:'https://www.merton.gov.uk/rubbish-and-recycling/recycling-sites' },
  { id:'junction-textiles', name:'Mitcham Junction Textile Recycling Bank', lat:51.3932, lng:-0.1570, categories:['recycling','donations'], address:'Mitcham Junction Station, Carshalton Road, CR4 4HG', description:'Council-listed textile recycling point.', source:'verified', sourceUrl:'https://www.merton.gov.uk/rubbish-and-recycling/recycling-sites' },
  ...
  { id:'pollards-textiles', name:'Pollards Hill Textile Recycling Bank', lat:51.4160, lng:-0.1365, categories:['recycling','donations'], address:'South Lodge Avenue, Pollards Hill', description:'Council-listed textile recycling point outside the local shops.', source:'verified', sourceUrl:'https://www.merton.gov.uk/rubbish-and-recycling/recycling-sites' },
